...
- **角色预览器**：可自定义全套装备预览（头盔、铠甲、护腿、护手、靴子、左右手武器、翅膀）；支持道具强化等级+0~+15、卓越、套装特效；覆盖全版本15+种角色职业；动画播放控制、配置预设存档。
...
### 角色预览专项功能
- 完整装备槽位系统（头盔、铠甲、护腿、护手、靴子、左右手、翅膀）
...
3. **穿戴装备**：分别设置头盔、铠甲、护腿、护手、靴子、左右手武器、翅膀
