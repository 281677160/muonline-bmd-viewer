...
const CLASS_OPTIONS: Array<{ value: number; label: string }> = [
  ...
  { value: 202, label: '骑士' },
  { value: 302, label: '神骑士' },
  { value: 402, label: '圣殿武士' },
  // 弓箭手系
  { value: 3, label: '弓箭手' },
  { value: 203, label: '圣射手' },
  { value: 303, label: '神射手' },
  { value: 403, label: '精灵游侠' },
  // 魔剑士系
  { value: 4, label: '魔剑士' },
  { value: 304, label: '剑圣' },
  { value: 404, label: '魔骑士' },
  ...
  // 召唤术师系
  { value: 6, label: '召唤术师' },
  { value: 206, label: '召唤导师' },
  { value: 306, label: '召唤巫师' },
  { value: 406, label: '大召唤师' },
  // 格斗家系
  { value: 7, label: '格斗家' },
  { value: 307, label: '格斗大师' },
  { value: 407, label: '格斗宗师' },
  // 梦幻骑士系
  { value: 8, label: '梦幻骑士' },
  { value: 308, label: '魅影骑士' },
  { value: 408, label: '光辉骑士' },
  // 符文法师系
  { value: 9, label: '符文法师' },
  { value: 209, label: '秘咒法师' },
  { value: 309, label: '奥术大师' },
  { value: 409, label: '灵魂咏者' },
  // 疾风系
  { value: 10, label: '疾风' },
  { value: 210, label: '逐影' },
  { value: 310, label: '碎梦' },
  ...
  { value: 11, label: '火枪手' },
  { value: 211, label: '狙击手' },
  { value: 311, label: '枪术大师' },
  { value: 411, label: '枪神' },
  // 光明法师系
  { value: 12, label: '光明法师' },
  { value: 212, label: '圣光法师' },
  { value: 312, label: '圣光导师' },
  { value: 412, label: '神官' },
  // 圣光学者系
  { value: 13, label: '圣光学者' },
  { value: 213, label: '圣光使者' },
  { value: 313, label: '圣光贤者' },
  { value: 413, label: '先知' },
  // 赤色战士系
  { value: 14, label: '赤色战士' },
  { value: 214, label: '幻夜骑士' },
  { value: 314, label: '幽影武士' },
  { value: 414, label: '血魂至尊' },
  // 炼金术士系
  { value: 15, label: '炼金术士' },
  { value: 215, label: '炼金魔师' },
  { value: 315, label: '炼金大师' },
  { value: 415, label: '原质学者' },
];
